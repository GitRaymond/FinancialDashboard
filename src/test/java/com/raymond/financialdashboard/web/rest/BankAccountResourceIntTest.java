...
import com.raymond.financialdashboard.repository.BankAccountRepository;
...
import com.raymond.financialdashboard.service.mapper.BankAccountMapper;
...
public class BankAccountResourceIntTest {
    ...
    public void createBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.getGoal()).isEqualTo(DEFAULT_GOAL);
    }
    ...
    public void updateBankAccount() throws Exception {
        ...
        assertThat(testBankAccount.getGoal()).isEqualTo(UPDATED_GOAL);
    }
